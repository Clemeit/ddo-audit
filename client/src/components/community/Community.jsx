    ...
    <div>
      ...
      <div className="content-container" style={{ position: "relative" }}>
        ...
        <ContentCluster
          ...
          description={
            <>
              These projects were developed by members of the DDO community. If
              you'd like to see a project added, please{" "}
        ...
        >
          <div className="content-cluster-options">
            {TOOLS.map((tool, i) => (
              ...
              >
                ...
                <p className="community-box-description">{tool.description}</p>
          ...
          >
            These are not my projects. DDO Audit is not necessarily affiliated
            with any of the projects listed here. All credit belongs to their
            respective owners. Do NOT message me with feedback or requests
