    ...
    return (
        <div style={{ display: props.visibility }}>
            ...
            <div className="report-issue-form card">
                ...
                <p>
                    Use this form to report an issue with the website or the
                    data it provides. If your issue requires a two-way
                    conversation or you'd like to request a change or addition
                    to the site, you should contact me on the DDO Forums,
                    Reddit, or Discord.
                </p>
                <form
                ...
                >
                    ...
                    <label>
                        Element: "
                        {props.componentReference &&
                            props.componentReference.title}
                        "
                    </label>
                    <input
                        className={
                            submitted ? "btn btn-success" : "btn btn-primary"
                        }
                        type="submit"
                        value={
                            submitted ? "We got your report. Thanks!" : "Submit"
                        }
                    />
                </form>
            </div>
