    ...
    return (
        <ContentCluster title="Frequently Asked Questions">
            <section id="faq-section">
                ...
                <p style={{ fontSize: "1.4rem" }}>
                    {props.defaultServer} is currently DDO's default server and
                    will have the most new players.
                </p>
                <h4
                    className="lfm-number"
                    style={{
                ...
                <p style={{ fontSize: "1.4rem" }}>
                    Server status can be checked on our "Live" page. The data is
                ...
                <p style={{ fontSize: "1.4rem" }}>
                    Yes, DDO is still active and receives periodic updates and
                    content releases. There have been{" "}
                    <span className="population-number">
                        {props.uniquePlayerCount}
                    </span>{" "}
                    unique characters and{" "}
                    <span className="lfm-number">{props.uniqueGuildCount}</span>{" "}
                    unique guilds on DDO in the last 90 days.
                </p>
            </section>
        </ContentCluster>
    );
