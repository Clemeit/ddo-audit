              ...
              <tbody>
                ...
                <tr className="social-member-entry">
                  ...
                  {props.player.Guild && (
                    <td
                      className="blue-link"
                      onClick={() => props.handleAddFilter("Guild")}
                    >
                ...
                <tr className="social-member-entry">
                  ...
                  >
                    {props.player.Location && props.player.Location.Name}
                  </td>
                  <td
                    className="blue-link"
                    onClick={() => props.handleAddFilter("Location")}
                  >
                ...
                <tr className="social-member-entry">
                  ...
                  {props.player.InParty === 1 && (
                    <td
                      className="blue-link"
                      onClick={() => props.handleAddFilter("Group")}
