...
const Panel = (props) => {
  ...
  React.useEffect(() => {
    ...
    setFilteredServerData({
      ...
      lfms: filtered_lfms.sort((a, b) => {
        let a_avg = (a.maximum_level + a.minimum_level) / 2;
        let b_avg = (b.maximum_level + b.minimum_level) / 2;
        let leader_id_compare = a["leader"]["id"] - b["leader"]["id"];
        let asc_sort_predicate = a_avg - b_avg || leader_id_compare;
        let desc_sort_predicate = b_avg - a_avg || leader_id_compare;
        return sortAscending ? asc_sort_predicate : desc_sort_predicate;
      }),
    });
  }, [
    unfilteredServerData,
  ...
  React.useEffect(() => {
    ...
    const SHOW_ACTIVITY_HISTORY = localStorage.getItem("show-activity-history");
    setShowActivityHistory(
      SHOW_ACTIVITY_HISTORY !== null ? SHOW_ACTIVITY_HISTORY === "true" : false
    );
            ...
            <ContentCluster title="Add-ons" smallBottomMargin>
              ...
              >
                ...
                <label className="filter-panel-group-option">
                  ...
                  <div
                    className="new-tag"
                    style={{ marginLeft: "10px", padding: "3px 7px" }}
                  >
                    NEW
                  </div>
                </label>
