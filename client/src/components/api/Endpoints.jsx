...
const Endpoints = (props) => {
    ...
    const LocationObject = (
        <ul>
            ...
            <li>
                The region name,{" "}
                <span className="api-field">Region [string]</span>
            </li>
        </ul>
    );
    ...
    const GroupDataDescription = (
        <div>
            <p style={{ marginBottom: "5px" }}>
                ...
                <span className="api-field">
                    Groups [
                    <span style={{ color: "var(--green-text)" }}>Group</span>{" "}
                    object array]
                </span>
                .<br />
                The{" "}
                ...
                <span style={{ color: "var(--green-text)" }}>Group</span>{" "}
                objects. Each{" "}
                <span style={{ color: "var(--green-text)" }}>Group</span> object
                ...
                The <span style={{ color: "var(--green-text)" }}>Quest</span>{" "}
                ...
                {PlayerObject}
                The <span style={{ color: "var(--green-text)" }}>
                    Class
                </span>{" "}
                    ...
                    description: (
                        <div>
                            <p style={{ marginBottom: "5px" }}>
                                ...
                                The data is returned as an array of{" "}
