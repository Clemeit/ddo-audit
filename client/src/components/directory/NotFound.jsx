                        ...
                        <div>
                            ...
                            <ul>
                                <li style={{ marginBottom: "10px" }}>
                                    If you clicked a bookmark with the
                                    "playeraudit" domain, you may need to update
                                    your bookmark.
                                </li>
                                <li style={{ marginBottom: "10px" }}>
                                    If you clicked on an old link, that link may
                                    be directing you to a page that no longer
                                    exists.
                                </li>
                            </ul>
                            <p>
                                Please use the navigation buttons to find the
                                page you were looking for, or return to the{" "}
