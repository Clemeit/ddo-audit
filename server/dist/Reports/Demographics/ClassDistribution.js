...
const runClassDistribution = (players, classes, reporttype) => {
    ...
    players.forEach(({ class1, level1, class2, level2, class3, level3, class4, level4, lastseen, lastactive, lastmovement, lastlevelup, totallevel, server, }) => {
    ...
    fs_1.default.writeFile(`../api_v1/demographics/classdistributionquarter${reporttype === "normal" ? "" : "_banks"}.json`, JSON.stringify(output), (err) => {
        if (err)
            throw err;
    });
    var t1 = new Date();
...
exports.default = runClassDistribution;
