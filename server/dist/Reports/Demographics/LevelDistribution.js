...
const runLevelDistribution = (players, reporttype) => {
    ...
    players.forEach(({ lastseen, lastactive, lastmovement, lastlevelup, totallevel, server, }) => {
    ...
    output.reverse();
    fs_1.default.writeFile(`../api_v1/demographics/leveldistributionquarter${reporttype === "normal" ? "" : "_banks"}.json`, JSON.stringify(output), (err) => {
        if (err)
            throw err;
    });
    var t1 = new Date();
...
exports.default = runLevelDistribution;
