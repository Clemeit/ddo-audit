 ...
 * @returns
 */
const isPlayerActive = (lastseen, lastactive, lastmovement, lastlevelup, totallevel, filterByLastSeen = false) => {
    const MAX_LEVEL = 32;
    ...
    let movement = lastmovement == null ? 0 : new Date(lastmovement + "Z").getTime();
...
exports.default = isPlayerActive;
