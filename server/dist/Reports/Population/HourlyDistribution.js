...
const runHourlyDistribution = (population, reporttype) => {
    ...
    output.reverse();
    fs_1.default.writeFile(`../api_v1/population/hourlydistributionquarter${reporttype === "population" ? "" : "_groups"}.json`, JSON.stringify(output), (err) => {
        if (err)
            throw err;
    });
    var t1 = new Date();
...
exports.default = runHourlyDistribution;
