...
const runServerDistribution = (population, reporttype) => {
    ...
    outputMonth.reverse();
    fs_1.default.writeFile(`../api_v1/population/serverdistributionquarter${reporttype === "population" ? "" : "_groups"}.json`, JSON.stringify(outputQuarter), (err) => {
        if (err)
            throw err;
    });
    fs_1.default.writeFile(`../api_v1/population/serverdistributionmonth${reporttype === "population" ? "" : "_groups"}.json`, JSON.stringify(outputMonth), (err) => {
        if (err)
            throw err;
    });
    var t1 = new Date();
...
exports.default = runServerDistribution;
